...
from .runner import Runner, Runner_singlehead
...
from utils.collect_env import collect_env, load_heads
...
def test_singlehead(cfg,
    ...
    runner = Runner_singlehead(logger=logger,
                video_batch_size=video_batch_size,
                Metric=Metric,
                record_dict=record_dict,
                cfg=cfg,
