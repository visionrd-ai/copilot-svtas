...
sample_rate = 4
clip_length = 32
vid_path = 'ins/IMG_3424.MOV'
mapping = {int(elem.strip().split(' ')[0]): elem.strip().split(' ')[-1] for elem in open('../data/thal/mapping.txt', 'r').readlines()}
output_path = 'IMG_3424_out.mp4'
